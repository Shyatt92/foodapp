  ...
  return (
    <div className='loginForm'>
      <form className='login'>
        ...
        <input type='email' name='email' id='email' className='formElement' required></input><br/>
      ...
      <form className='signup'>
        <label htmlFor='email' className='formElement'>Email</label>
        <input type='email' name='email' id='email' className='formElement' required></input><br/><br/>
